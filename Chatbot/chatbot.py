...
class Chatbot:
    def __init__(self,root):
        ...
        img_chat=Image.open('cb.jpeg')
        img_chat= img_chat.resize((200, 70), Image.BICUBIC)
        self.photoimg=ImageTk.PhotoImage(img_chat)

        Title_label=Label(main_frame,bd=3,relief=RAISED,anchor='nw',width=730,compound=LEFT,image=self.photoimg,text="LET'S TALK",font=('arial',30,'bold'),fg='green',bg='white')
